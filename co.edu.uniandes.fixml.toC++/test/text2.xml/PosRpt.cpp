...
public class PosRpt {
	...
	public PosRpt () {
  	...
  	// by parameters
  	public PosRpt (		String RptID_, String Rslt_, String BizDt_, String Acct_, String AcctTyp_, String SetPx_, String SetPxTyp_, String PriSetPx_, String ReqTyp_, String Ccy_, Hdr* Hdr_1, Pty* Pty_1, Pty* Pty_2, Pty* Pty_3, Qty* Qty_1, Qty* Qty_2, Qty* Qty_3, Amt* Amt_1, Instrmt* Instrmt_1){
