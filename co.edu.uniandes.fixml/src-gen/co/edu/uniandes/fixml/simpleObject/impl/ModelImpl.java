 ...
 * <ul>
 *   <li>{@link co.edu.uniandes.fixml.simpleObject.impl.ModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link co.edu.uniandes.fixml.simpleObject.impl.ModelImpl#getClazzes <em>Clazzes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return SimpleObjectPackage.Literals.MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleObjectPackage.MODEL__NAME, oldName, name));
	}
	...
	public EList<Clazz> getClazzes() {
		if (clazzes == null) {
			clazzes = new EObjectContainmentEList<Clazz>(Clazz.class, this, SimpleObjectPackage.MODEL__CLAZZES);
		}
		return clazzes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimpleObjectPackage.MODEL__CLAZZES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleObjectPackage.MODEL__NAME:
				return getName();
			case SimpleObjectPackage.MODEL__CLAZZES:
				return getClazzes();
		}
