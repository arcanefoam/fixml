...
class Order {
	...
	Order () {
		...
		OrderDuration_1 = new OrderDuration();
		Rule80A_1 = new Rule80A();
  	
  	}
  
  	// by parameters
  	Order (		, ClOrdID* ClOrdID_1, HandInst* HandInst_1, Instrument* Instrument_1, Side* Side_1, TransactTime* TransactTime_1, OrderQuantity* OrderQuantity_1, OrderType* OrderType_1, Currency* Currency_1, OrderDuration* OrderDuration_1, Rule80A* Rule80A_1){
		...
		this->OrderDuration_1 = OrderDuration_1;
