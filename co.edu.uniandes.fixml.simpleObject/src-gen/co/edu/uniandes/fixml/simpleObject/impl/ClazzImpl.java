...
public class ClazzImpl extends MinimalEObjectImpl.Container implements Clazz {
	...
	public EList<Instance> getInstances() {
		if (instances == null) {
			instances = new EObjectContainmentEList<Instance>(Instance.class, this, SimpleObjectPackage.CLAZZ__INSTANCES);
		}
		return instances;
	}
	...
	public EList<Clazz> getClazzes() {
		if (clazzes == null) {
			clazzes = new EObjectContainmentEList<Clazz>(Clazz.class, this, SimpleObjectPackage.CLAZZ__CLAZZES);
		}
		return clazzes;
	}
