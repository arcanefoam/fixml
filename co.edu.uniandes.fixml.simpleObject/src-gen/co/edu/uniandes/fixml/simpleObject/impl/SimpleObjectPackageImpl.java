...
public class SimpleObjectPackageImpl extends EPackageImpl implements SimpleObjectPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getClazz_Instances(), this.getInstance(), null, "instances", null, 0, -1, Clazz.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
